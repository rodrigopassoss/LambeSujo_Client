...
QT_MOC_LITERAL(1, 14, 11), // "new_command"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 16), // "connectToNetwork"
QT_MOC_LITERAL(4, 44, 21), // "disconnectFromNetwork"
QT_MOC_LITERAL(5, 66, 9) // "runClient"

    },
    "RefereeClient\0new_command\0\0connectToNetwork\0"
    "disconnectFromNetwork\0runClient"
};
...
void RefereeClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->new_command(); break;
        case 1: _t->connectToNetwork(); break;
        case 2: _t->disconnectFromNetwork(); break;
        case 3: _t->runClient(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (RefereeClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RefereeClient::new_command)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RefereeClient::new_command()
{
