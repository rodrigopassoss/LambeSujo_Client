...
QT_MOC_LITERAL(1, 7, 13), // "visionUpdated"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 14), // "initialization"
QT_MOC_LITERAL(4, 37, 4), // "loop"
QT_MOC_LITERAL(5, 42, 12) // "finalization"

    },
    "Vision\0visionUpdated\0\0initialization\0"
    "loop\0finalization"
};
...
void Vision::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->visionUpdated(); break;
        case 1: _t->initialization(); break;
        case 2: _t->loop(); break;
        case 3: _t->finalization(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Vision::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Vision::visionUpdated)) {
                *result = 0;
                return;
            }
        }
